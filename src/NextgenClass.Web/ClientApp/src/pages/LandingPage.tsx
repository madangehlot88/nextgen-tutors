...
const boards = [
  { name: 'CBSE', desc: 'Complete science coaching for Classes 6-12 following CBSE curriculum', color: 'from-brand-blue to-brand-blue-dark' },
  { name: 'ICSE', desc: 'In-depth science preparation aligned with ICSE syllabus', color: 'from-brand-blue-light to-brand-blue' },
  { name: 'GSEB', desc: 'Gujarat Board science subjects with expert local tutors', color: 'from-brand-orange to-brand-orange-dark' },
  { name: 'JEE Mains & Advanced', desc: 'Physics, Chemistry & Math coaching for IIT aspirants', color: 'from-brand-blue-dark to-[#0D3259]' },
  { name: 'NEET', desc: 'Biology, Physics & Chemistry preparation for medical entrance', color: 'from-brand-orange-dark to-[#8B5A1B]' },
  { name: 'Foundation', desc: 'Strong foundation building for Classes 6-10 in all science subjects', color: 'from-brand-gold to-brand-orange' },
  { name: 'Olympiad', desc: 'Specialized preparation for Science & Math Olympiad competitions', color: 'from-brand-blue to-brand-blue-light' },
]
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-brand-blue via-brand-blue-dark to-[#0D3259] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-brand-orange-light mb-4 font-semibold">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register/student" className="bg-brand-orange text-white px-8 py-3 rounded-lg font-semibold text-lg hover:bg-brand-orange-dark transition shadow-lg">
                Register as Student
              </Link>
              <Link to="/register/tutor" className="border-2 border-brand-orange-light text-brand-orange-light px-8 py-3 rounded-lg font-semibold text-lg hover:bg-brand-orange-light/10 transition">
                Become a Tutor
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition hover:border-brand-orange-light/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Physics', 'Chemistry', 'Biology', 'Mathematics', 'Science (General)'].map((s) => (
              <span key={s} className="bg-white border border-brand-blue/20 px-6 py-3 rounded-full text-brand-blue font-medium shadow-sm">
                {s}
              </span>
            ))}
          </div>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {submitted ? (
            <div className="bg-green-50 border border-green-200 text-green-800 p-6 rounded-xl text-center">
              ...
              <button onClick={() => setSubmitted(false)} className="mt-4 text-brand-blue underline">Send another inquiry</button>
            </div>
          ) : (
